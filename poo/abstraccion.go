...
// ! EN GO COMO TAL NO EXISTEN LOS CONCEPTOS DE POO TRADICIONALES DEBIDO A SU NATURALEZA. PERO SE PUEDEN MANEJAR O LLEGAR A UN RESULTADO IGUAL O INCLUSO MEJOR.

// ! DATO BUENO ES QUE EN GO NO EXISTEN LAS "clases" COMO TAL

// ? DECLARAMOS LA ESTRUCTURA. COMO SI FUERA LA "clase"
type Course struct {
	Name    string
	Price   float64
	IsFree  bool
